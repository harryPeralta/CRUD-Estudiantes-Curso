            ...
            <div class="mt-5 mb-5 p-2 card bg-light rounded shadow">
                ...
                <form action="modificarEstudiante.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control"  type="number" id="id"  name="id" value= "<?php echo $estudiante['id'] ?>"  readonly> 
                    </div>

                    <div class="form-group">
                        <label for="nombre"> Nombre:</label>
                        <input class="form-control" type="text" id="nombre"  name="nombre" value= "<?php echo $estudiante['nombre'] ?>"> 
                    </div>
                    <div class="form-group">
                        <label for="edad"> Edad:</label>
                        <input class="form-control" type="number" id="edad"  name="edad" min="1" max="99" placeholder="Escriba aqui su edad" value= "<?php echo $estudiante['edad'] ?>"> 
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="genero" id="genero">
                            ...
                            <option <?php if($estudiante['genero'] == 'Femenino') echo "selected"; ?> value="Femenino">Femenino</option>
                            <option <?php if($estudiante['genero'] == 'Masculino') echo "selected"; ?> value="Masculino">Masculino</option>
                        </select>
                    
    
                    </div> <br>
                  
                    <button class="btn btn-secundary btn-danger" type ="sumbit" >Modificar</button>
