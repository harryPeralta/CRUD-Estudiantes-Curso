...
$sql = "UPDATE curso SET codigo = '$codigo', nombre = '$nombre', horario = '$horario' WHERE codigo = '$codigo'";
    
        //Enviar la consulta

        if (mysqli_query($conn, $sql) ) {
            echo "!Se ha modificado el registro satisfactoriamente ";
        }
        else{
...
?> 
    <br>
        <a href="listaCurso.php" class = "btn btn-primary mt-3">Lista Curso</a>
    </div>
    </div>
