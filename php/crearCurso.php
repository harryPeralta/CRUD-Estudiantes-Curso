...
<nav class=" navbar navbar-expand-lg navbar-light bg-warning">
    ...
    <div class="container borde">
        ...
        <center>
        <h1 class="titulo"> Crear Curso</h1>
    </center>
       

            <div class="mt-5 mb-5 p-2 card bg-light rounded shadow">
                <div class="card-body">
                <form action="accionesCurso.php" method="post">

                    <div class="form-group">
                        <label for="codigo"> Código:</label>
                        <input class="form-control" type="text" id="codigo"  name="codigo" placeholder="Escriba aqui el código"> 
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="horario" id="horario" placeholder="Escriba aqui el horario">
                        </input>
