...
<nav class=" navbar navbar-expand-lg navbar-light bg-warning">
    ...
    <div class="container borde">
        <center>
        <h1 class="titulo"> Modificar Curso</h1>
    </center>
            ...
            <div class="mt-5 mb-5 p-2 card bg-light rounded shadow">
                ...
                <form action="modificarCurso.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control"  type="text" id="codigo"  name="codigo" value= "<?php echo $curso['codigo'] ?>"  readonly> 
                    </div>

                    <div class="form-group">
                        <label for="nombre"> Nombre:</label>
                        <input class="form-control" type="text" id="nombre"  name="nombre" value= "<?php echo $curso['nombre'] ?>"> 
                    </div>
                    <div class="form-group">
                        <label for="horario"> Horario:</label>
                        <input class="form-control" type="text" id="horario"  name="horario"  value= "<?php echo $curso['horario'] ?>"> 
                    </div>
