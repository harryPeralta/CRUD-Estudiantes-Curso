                    ...
                    if($cursos)
                    {
                        foreach($cursos as $curso)
                        {
                            ...
                            echo "<td>";
                                ...
                                echo " <a href = 'readCurso.php?codigo=" .$curso['codigo'] ."'class ='btn btn-info rounded-circle'> <i class='far fa-eye'></i> </a> ";                               
                                echo " <a href = 'updateCurso.php?codigo=" .$curso['codigo'] ."'class ='btn btn-info rounded-circle'> <i class='fas fa-pen'></i> </a> ";                               
                                echo "<a href = 'deleteCurso.php?codigo=" .$curso['codigo'] ."'class ='btn btn-danger rounded-circle'> <i class='far fa-trash-alt'></i> </a>";                                
